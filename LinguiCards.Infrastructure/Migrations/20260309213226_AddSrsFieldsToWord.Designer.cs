...
namespace LinguiCards.Infrastructure.Migrations
{
    ...
    [Migration("20260309213226_AddSrsFieldsToWord")]
    partial class AddSrsFieldsToWord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinguiCards.Domain.Entities.DailyGoal", b =>
                {
                    ...
                    b.Property<int>("ByGrammar")
                        .HasColumnType("integer");

                    b.Property<int>("ByTranslation")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LinguiCards.Domain.Entities.IrregularVerb", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LinguiCards.Domain.Entities.Word", b =>
                {
                    ...
                    b.Property<double>("ActiveEaseFactor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double precision")
                        .HasDefaultValue(2.5);

                    b.Property<int>("ActiveIntervalDays")
                        .HasColumnType("integer");

                    b.Property<double>("ActiveLearnedPercent")
                        .HasColumnType("double precision");

                    b.Property<DateTime?>("ActiveNextReviewDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("ActiveRepetitionCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("PassiveEaseFactor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double precision")
                        .HasDefaultValue(2.5);

                    b.Property<int>("PassiveIntervalDays")
                        .HasColumnType("integer");

                    b.Property<double>("PassiveLearnedPercent")
                        .HasColumnType("double precision");

                    b.Property<DateTime?>("PassiveNextReviewDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("PassiveRepetitionCount")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ActiveNextReviewDate");

                    b.HasIndex("LanguageId");

                    b.HasIndex("PassiveNextReviewDate");
